...
for i=1, numProductions_1 do
 table.insert(prods_1, component.proxy(component.findComponent(identifier .. "_Prod1_" .. i)[1]))
end
local prods_2 = {}
for i=1, numProductions_2 do
 table.insert(prods_2, component.proxy(component.findComponent(identifier .. "_Prod2_" .. i)[1]))
end

local prods_3 = {}
for i=1, numProductions_3 do
 table.insert(prods_3, component.proxy(component.findComponent(identifier .. "_Prod3_" .. i)[1]))
end
